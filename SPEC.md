...
- **`players`** — `id, sleeper_player_id (TEXT, unique when non-null), first_name, last_name, position, nfl_team_id (nullable), birth_date (TEXT, YYYY-MM-DD), active`. Store birth date, compute age. No availability here.
